...
describe.skip('send', () => {
  it('max length', async () => {
    const message= 'q'.repeat(4096)

    await send(testUser().mid, {message})
  })

  it('split long', async () => {
    await send(testUser().mid, {
      message:`
